...
public class Animal {
	...
	public void setNome(String nome) throws Exception {
		...
		if (nome.length() > 50)
			throw new Exception("O nome n�o pode ter mais de 50 caracteres.");
		this.nome = nome;
	}
	...
	public void setNascimento(Date nascimento) throws DateTimeException {
		if (nascimento != null && (new Date()).compareTo(nascimento) < 0)
			throw new DateTimeException("A data/hora de nascimento do animal n�o pode ser maior que a atual");
